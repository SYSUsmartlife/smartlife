...
public class NetworkConfig {
	...
	// 更改用户名时使用
	public final static String URL_CHANGE_NAME = SERVER
			+ "SmartLife/index.php/Api/changeUserName";
	...
	// 获取用户信息时使用
	public final static String URL_GET_USER = SERVER
			+ "SmartLife/index.php/Api/getUserById";
	...
	// 修改密码时使用
	public final static String URL_CHANGE_PASSWORD = SERVER
			+ "SmartLife/index.php/Api/changePassword";
	...
	// 组长处理申请时使用
	public final static String URL_REPLY_REQUEST = SERVER + "SmartLife/index.php/Api/replyRequest";
	public final static String KEY_REPLY_REQUEST_GROUP_ID = "groupId";
